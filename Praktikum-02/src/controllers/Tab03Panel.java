 ...
 */           
    private void initComponents() {
        ...
        jtfEach01.addFocusListener(new FocusAdapter(){
            @Override
            ...
            public void focusLost(FocusEvent e){
                jtfEach01.setText(jtfEach01.getText().isBlank() || 
                                  jtfEach01.getText().equals("-") 
                          ? "0" : jtfEach01.getText());
            }
        });
        ...
        jtfEach02.addFocusListener(new FocusAdapter(){
            @Override
            public void focusGained(FocusEvent e){
                jtfEach02.setText("");
            }
            @Override
            public void focusLost(FocusEvent e){
                jtfEach02.setText(jtfEach02.getText().isBlank() || 
                                  jtfEach02.getText().equals("-") 
                          ? "0" : jtfEach02.getText());
            }
        });
        ...
        jtfEach03.addFocusListener(new FocusAdapter(){
            @Override
            public void focusGained(FocusEvent e){
                jtfEach03.setText("");
            }
            @Override
            public void focusLost(FocusEvent e){
                jtfEach03.setText(jtfEach03.getText().isBlank() || 
                                  jtfEach03.getText().equals("-") 
                          ? "0" : jtfEach03.getText());
            }
        });
...
/*
 * Item state Event Listener for the radio buttons component
 */
    @Override
